...
describe('ContactEditor', () => {
  ...
  it('TC-052: renders contact fields and info notes', () => {
    ...
    // Check for Section Header labels
  ...
  it('TC-054: changing a form field label updates draft state immediately', async () => {
    ...
    // Since it's the last added field, we can just grab all Label inputs inside Form Fields
    // Let's grab all inputs with label /Label/i (Wait, "Label" is also used for Submit Button Label)
